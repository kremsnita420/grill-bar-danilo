...
import { Section } from '../components/contact/ContactStyles'
...
export default function Contact() {
    ...
    return (
        <Section>
            ...
            <iframe title="Intentionally blank" frameBorder="0" style={{ width:"500px", height:"500px", border:"0", allowFullScreen:"", loading:"lazy"}} 
